...
# Determine the image path to analyze
...
img = xrv.utils.load_image_as_grayscale(image_path) if hasattr(xrv.utils, "load_image_as_grayscale") else None
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        # Programmatic call - output clean JSON only
        print(json.dumps(xray_summary))
    else:
